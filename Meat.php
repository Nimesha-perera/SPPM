...
<head>
    ...
    .main {
        background: linear-gradient(rgba(0, 0, 0, 0.5),
                rgba(0, 0, 0, 0.5)), url(imagesN/meat.jpg);
        ...
        <div class="container py-5">
            <div class="row py-5">
                <div class="col-lg-7 pt-5 ">
                    <h1 class="pt-5">Take a break, have our meat</h1>
                    <p>Buy your daily protein here</p>
  ...
  ?>
    ...
    <div class="container py-5">
      ...
      ?>
            ...
            $query = "SELECT * FROM products WHERE category='Meat'";
