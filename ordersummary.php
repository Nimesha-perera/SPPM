        ...
        <div class="row">
            ...
            <div class="col-sm-10 bg-light">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <h1 class="text-center pt-4 pb-5"><strong>Order Summary</strong></h1>
                ...
                <div class="container mx-auto">
                    <div class="col-sm-2">
                        <p class="pt-5 text-center">
                            <a href="orderstat.php" class="btn btn-outline-warning">Back</a>
                        </p>
                    </div>
                    ...
                    $query = "SELECT * FROM `checkout` where inx=$cid";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        $array = json_decode($row["summary"], true);
                        echo " <ul class='list-group'>
                        <li class='list-group-item list-group-item-success'>" . $array[0] . "   <pre>      </pre> " . $array[1] . "</li>
