...
<head>
    ...
    .main {
        background: linear-gradient(rgba(0, 0, 0, 0.5),
                rgba(0, 0, 0, 0.5)), url(imagesN/vegetables.jpg);
        ...
        <div class="container py-5">
            <div class="row py-5">
                <div class="col-lg-7 pt-5 ">
                    <h1 class="pt-5">Veg a day is a healthy way</h1>
                    <p>Buy your fresh vegetables here</p>
                    <div class="col text-center">
                        <button class="btn1 mt-3"><a class="smoothScroll" href="#product">Explore the
                                products</a></button>
                    </div>
                </div>
            </div>
