        ...
        <div class="col-sm-2 height " style="background-color: #2baf63; height:1500px">
            ...
            <div class="col-sm-10">
                ...
                <div class="container mx-auto">
                    <form action="updatep.php" id="the-form" class="form-control w-50 mx-auto"
                        ...
                        <input type="text" name="productname" class="form-control" placeholder="Enter Product name"
                            required value="<?php echo $row['productname'] ?>">
                        ...
                        <input type="text" name="productprice" class="form-control" placeholder="Enter Product price"
                            required value="<?php echo $row['productprice'] ?>">
                        ...
                        <input type="text" name="quantity" class="form-control" placeholder="Enter Product quantity"
                            required value="<?php echo $row['quantity'] ?>">

                        <label class="pt-4 pb-2 text-center">Enter description</label>
                        <input type="text" name="description" class="form-control"
                            placeholder="Enter Product description" required value="<?php echo $row['description'] ?>">

                        <label class="pt-4 pb-2 text-center" id="category" name="category" required
                            placeholder="category" <?php if ($row['id'] == $row['category']) { ?> selected="selected"
                        ...
                        <img src="upload/<?php echo $row['image'] ?>" style="width:300px; height:300px;" >
                        ...
                        <button type="submit" name="updatebtn" class="btn btn-primary form-control"
                            onclick="myFunction()">Update product</button>
