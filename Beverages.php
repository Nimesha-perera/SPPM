...
if ($_SESSION['login_user'] != null) {
    ...
    header("Location: Beverages-logged.php");
}else {
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" mathod="POST" action="">
                    <input class=" px-2 search" name="searchbar" type="search" placeholder="Search" aria-label="Search">
                    <button class="btn0 " type="searchbut" name="searchNav">Search</button>
                </form>
            ...
            <div class="container">
                <table class="table-responsive w-100 p-3">
                    <tbody>
                        <tr>
                            <div class="cat">
                                <td style="color:black;"><img src="imagesN/vegetable_icon.png" alt="Product"
                                        style="height: 30px;"><a href="Vegetables.php"
                                        style="color:black;">Vegetables</a></td>
                                <td style="color:black;"><img src="imagesN/friut_icon.png" alt="Product"
                                        style="height: 30px;"><a href="Fruit.php" style="color:black;">Fruits</a></td>
                                <td style="color:black;"><img src="imagesN/grocery_icon.png" alt="Product"
                                        style="height: 30px;"><a href="Grocery.php" style="color:black;">Grocery</a>
                                </td>
                                <td style="color:black;"><img src="imagesN/meat_icon.png" alt="Product"
                                        style="height: 30px;"><a href="Meat.php" style="color:black;">Meat</a></td>
                                <td style="color:black;"><img src="imagesN/beverage_icon.png" alt="Product"
                                        style="height: 30px;"><a href="Beverages.php" style="color:black;">Beverages</a>
                                </td>
                                <td style="color:black;"><img src="imagesN/household_icon.png" alt="Product"
                                        style="height: 30px;"><a href="Household.php" style="color:black;">Household</a>
                                </td>
                            </div>
                        </tr>
                    </tbody>
            ...
            <footer class="footer-bs">
                <div class="row">
                    ...
                    <div class="col-md-4 footer-nav animated fadeInUp">
                        ...
                        <li><a href="abous_us_.html">About Us </a>
            <p>Get to know us</p>
        </li>
