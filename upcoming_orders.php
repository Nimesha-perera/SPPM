        ...
        <div class="mt-0 mb-5 col-lg-10 col-md-12 offset-lg-1">
            ...
            <div class="m-0 row">
                <div class="col-lg-3 col-sm-12">
                    ...
                    <div class="account_list">
                        <a href="upcoming_orders.php" style="color: #2baf63;">Upcoming Orders ></a>
                    </div>
                    <div class="account_list">
                    ...
                    <div class="account-content-holder">
                        <div class="m-0 row">
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="col-12 section-heading mb-3" style="font-weight: bold;">Upcoming Orders
                                    </div>
                                    <hr>
                        ...
                        $query = "SELECT DISTINCT inx,subtot FROM checkout WHERE customerID='$userID' AND (status='1' OR status = 'Ready for the Delivery')";
                ...
                $query1 = "SELECT DISTINCT summary FROM checkout WHERE customerID='$userID' AND (status='1' OR status = 'Ready for the Delivery')";
