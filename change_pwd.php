        ...
        <div class="mt-0 mb-5 col-lg-10 col-md-12 offset-lg-1">
            ...
            <div class="m-0 row">
                <div class="col-lg-3 col-sm-12">
                    ...
                    <div class="account_list">
                        <a href="change_pwd.php" style="color: #2baf63;">Change Password ></a>
                    </div>
                    <div class="account_list">
                ...
                <div class="col-lg-9 col-sm-12">
                    <div class="account-content-holder">
                        <div class="m-0 row">
                            <div class="card"
                                ...
                                <div class="card-body">
                                    <div class="col-12 section-heading mb-3" style="font-weight: bold;">Change Password
                                    </div>
                                    <hr>
                                    <div class="row mt-2">
                                        <form action="" method="POST">
                                            <div class="col-md-6">
                                                <label clas="form-label">Current Password</label>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6">
                                            <label clas="form-label">New Password</label>
                                            <input type="text" id="new_pwd" name="new_pwd" class="form-control">
                                            <span id="fname-error" style="color: red; font-size: 12px;"></span>
                                        </div>
                                        <div class="col-md-6">
                                            <label clas="form-label">Confirm New Password</label>
                                            <input type="text" id="confirm_pwd" name="confirm_pwd" class="form-control">
                  ...
                  $connect1 = mysqli_connect("localhost", "root", "", "liyanage");
                  if (isset($_POST['search'])) {
                    $cur_pwd = $_POST['current_pwd'];

                    $query = "SELECT password FROM user where email='$user_check'";
                    ...
                    if ($row = mysqli_fetch_array($query_run)) {
                      if ($cur_pwd ==  $row['password']) {
                        ...
                        if ($new_pwd == $confirm_pwd) {
                          $query1 = "UPDATE user SET password = '$new_pwd' where email='$user_check'";
                          ...
                          echo '<span style="color:red;text-align:center;">New Passwords does not match!</span>';
                        }
                      } else {
                        echo '<span style="color:red;text-align:center;">Please enter the correct Current Password!</span>';
                      }
                    }
                  }
