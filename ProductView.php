    ...
    <div class="col-md-8">
     <div class="card-body">
      <form method="POST" action="ProductView.php">
              ...
              <h6 class="card-text" id="price" name="price">Rs. <?= $row['Price']?>.00</h6>
            ...
            <button type="submit" class="addtocart" name="btnSubmit" id="btnSubmit">ADD TO CART</button>
            </form>
            </div>
            <?php
      }
      ...
      if(isset($_POST["btnSubmit"]) && $_POST["btnSubmit"]!=""){ 
        ...
        $sql = "NSERT INTO cart (UserID,ProductID,Quantity,Price)VALUES ($userID,$id,$quantity,$price)";
